...
def cal_mass(dataframe, particles, mass):
    ...
    for i in range(len(particles)):
        E += np.sqrt(dataframe[particles[i] + '_P'] ** 2 + mass_dict[mass[i]] ** 2)
...
def peaking_back_1(dataframe):
    ...
    (cal_mass(dataframe, ['K', 'Pi'], ['K', 'K']) >= 1010) &  ( 1030 >= cal_mass(dataframe, ['K', 'Pi'], ['K', 'K']))
...
def peaking_back_2(dataframe):
    ...
    crit = ( DLL(dataframe[L_1],dataframe[L_2]) > 10) & \
    (cal_mass(dataframe, ['K', 'Pi'], ['K', 'K']) >= 1030) &  (1075 >= cal_mass(dataframe, ['K', 'Pi'], ['K', 'K']))
...
def peaking_back_3(dataframe):
    crit = (cal_mass(dataframe, ['K', 'Pi', 'mu_plus', 'mu_minus'], ['K', 'K', 'mu_plus', 'mu_minus']) >= 5321) &  (5411 >= cal_mass(dataframe, ['K', 'Pi', 'mu_plus', 'mu_minus'], ['K', 'K', 'mu_plus', 'mu_minus'] ))
...
def peaking_back_4(dataframe):
    ...
    crit = ( DLL(dataframe[L_1[0]],dataframe[L_2[0]]) > DLL(dataframe[L_1[1]],dataframe[L_2[1]]))
...
def peaking_back_5(dataframe):
    ...
    crit = ( DLL(dataframe[L_1], dataframe[L_2]) > 0) & (5665 >= cal_mass(dataframe, ['K', 'Pi', 'mu_plus', 'mu_minus'], ['K', 'p', 'mu_plus', 'mu_minus'])) & (cal_mass(dataframe, ['K', 'Pi', 'mu_plus', 'mu_minus'], ['K', 'p', 'mu_plus', 'mu_minus']) >= 5575)
...
def peaking_back_6(dataframe):
    ...
    crit = ( DLL(dataframe[L_1], dataframe[L_2]) > 0) & (5665 >= cal_mass(dataframe, ['K', 'Pi', 'mu_plus', 'mu_minus'], ['p', 'K', 'mu_plus', 'mu_minus'])) & (cal_mass(dataframe, ['K', 'Pi', 'mu_plus', 'mu_minus'], ['p', 'K', 'mu_plus', 'mu_minus']) >= 5575)
...
def peaking_back_7(dataframe):
    ...
    crit1 = ( DLL(dataframe[L_1], dataframe[L_2]) > 5.0) & (3156 >= cal_mass(dataframe, ['Pi', 'mu_plus'], ['mu_minus', 'mu_plus'])) & (cal_mass(dataframe, ['Pi', 'mu_plus'], ['mu_minus', 'mu_plus']) >= 3036)
    crit2 = ( DLL(dataframe[L_1], dataframe[L_2]) > 5.0) & (3156 >= cal_mass(dataframe, ['Pi', 'mu_minus'], ['mu_plus','mu_minus'])) & (cal_mass(dataframe, ['Pi', 'mu_minus'], ['mu_plus','mu_minus']) >= 3036)
...
def peaking_back_8(dataframe):
    ...
    crit1 = ( DLL(dataframe[L_1], dataframe[L_2]) > 5.0) & (3156 >= cal_mass(dataframe, ['K', 'mu_plus'], ['mu_minus', 'mu_plus'])) & (cal_mass(dataframe, ['K', 'mu_plus'], ['mu_minus', 'mu_plus']) >= 3036)
    crit2 = ( DLL(dataframe[L_1], dataframe[L_2]) > 5.0) & (3156 >= cal_mass(dataframe, ['K', 'mu_minus'], ['mu_plus','mu_minus'])) & (cal_mass(dataframe, ['K', 'mu_minus'], ['mu_plus','mu_minus']) >= 3036)
