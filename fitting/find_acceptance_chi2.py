...
"""
Run the importing bit by itself in GitHub/Team7_Code so that it imports from the right directory lol
"""
import numpy as np
import pandas as pd
...
params_dict = {
    ...
    'i_range': 5,#now obsolete as we run the fitting through a loop below
    'j_range': 4,
}
...
acceptance_func_discrete = fil_cnt/sig_cnt
...
# c will store coefficients
        ...
        #chi2=scipy.stats.chisquare(f_obs=params_dict['acceptance_func_discrete'],f_exp=acceptance_function(params_dict['eq2_mid'],params_dict['ctl_mid'][1],params_dict))
